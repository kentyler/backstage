...
def format_documentation(comments, output_format='markdown'):
    ...
    if output_format == 'markdown':
        ...
        # Could add support for HTML, etc.
...
def main():
    parser = argparse.ArgumentParser(description='Extract JSDoc comments from project files.')
    ...
    try:
        ...
        output = format_documentation(all_comments, args.format)
