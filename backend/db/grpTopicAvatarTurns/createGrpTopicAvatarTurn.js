// src/db/grpTopicAvatarTurns/createGrpTopicAvatarTurn.js
...
export async function createGrpTopicAvatarTurn(
  ...
  console.log('createGrpTopicAvatarTurn called with clientPool:', clientPool ? 'provided' : 'not provided');
  ...
  // Using the renamed grp_topic_avatar_turns table
  const query = `
