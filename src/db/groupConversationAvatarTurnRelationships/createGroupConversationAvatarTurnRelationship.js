// createGroupConversationAvatarTurnRelationship.js
 ...
 */
export async function createGroupConversationAvatarTurnRelationship(
  turnId,
  targetTurnId,
  relationshipTypeId = 1
) {
  const sql = `
    INSERT INTO public.group_conversation_avatar_turn_relationships
