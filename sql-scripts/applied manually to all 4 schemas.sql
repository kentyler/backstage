applied manually to all 4 schemas
...
INSERT INTO public.grp_con_types (name, description) 
VALUES 
...
ALTER TABLE first_congregational.grp_cons
...
UPDATE first_congregational.grp_cons
...
CREATE INDEX idx_grp_cons_type_id ON first_congregational.grp_cons(type_id);
